...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 1 Get the elements from the DOM that you will work on (box container, new box button, color form, color input
    ...
    // 2 Create variables to store the box color and counter for the box ID.
    ...
    // 3 When the form is submitted, get the value from the color input element from Step 2 and set this color to all boxes (to get all boxes, use the class name box). Remember to reset the color input element's value and store the color in the box color variable we created in Step 3.
