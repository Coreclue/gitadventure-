...
class BinarySearchTree {
   ...
   * Returns the tree. Uses iteration. This function should insert a node in a binary tree. It should return the BinarySearchTree and should be solved using iteration. */
   ...
   * return the node, if found; else undefined. Uses iteration. This function should find a node in a binary tree. It should return the node if found, otherwise return ***undefined***. This should be solved using iteration.
...
``` */
   ...
   * return the node, if found; else undefined. Uses recursion. This function should find a node in a binary tree. It should return the node if found, otherwise return undefined. This should be solved using recursion. */
   ...
   * Return an array of visited nodes. This function should search through each node in the binary search tree using pre-order depth first search and return an array containing each node’s value.
...
``` */
   ...
   * Return an array of visited nodes. This function should search through each node in the binary search tree using breadth first search and return an array containing each node’s value.*/
   ...
   * Returns the removed node. This function should remove a node from a binary search tree. Your remove function should be able to handle removal of the root node, removal of a node with one child and removal of a node with two children. The function should return the node removed.*/
